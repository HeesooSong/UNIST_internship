---
title: "spot_clustering_Limit_Ranges"
author: "Heesoo Song"
date: '2022 12 5 '
...
if (intensity == "int"){
  ...
  df_meta_norm_int <- df_meta_norm[,c("C1_int_sig", "C2_int_sig", "C3_int_sig", "C4_int_sig")]
}
...
if (intensity == "int"){
 ggpairs(df_meta_norm, columns=c("C1_sigma", "C2_sigma", "C3_sigma", "C4_sigma", "C1_int", "C2_int", "C3_int", "C4_int"), aes(colour=cluster, alpha = 0.5), lower=list(continuous='points'), axisLabels='none')#, upper=list(continuous='blank')) 
  ...
  ggpairs(df_meta_norm, columns=c("C1_sigma", "C2_sigma", "C3_sigma", "C4_sigma", "C1_int_sig", "C2_int_sig", "C3_int_sig", "C4_int_sig"), aes(colour=cluster, alpha = 0.5), lower=list(continuous='points'), axisLabels='none')#, upper=list(continuous='blank'))
}
